            ...
            <div class="col-lg-4 col-md-10 col-sm-10 col-10 justify-content-center text-center form-card">
                ...
                <form action="" method="post" class="form" id="register-form">
                    ...
                    <div class="form-group">
                        <input type="text" name="username" id="username" class="form-control" placeholder="Introduceti username-ul" data-rule="minlen:6" data-msg="Introduceti cel putin 6 caractere">
                        <div class="validation text-left text-danger uName"></div>
                    </div>
                    <div class="form-group">
                        <input type="email" name="email" id="email" class="form-control" placeholder="Introduceti email-ul" data-rule="email" data-msg="Va rog sa introduceti email-ul">
                        <div class="validation text-left text-danger"></div>
                    </div>
                    <div class="form-group">
                        <input type="password" name="password" id="password" class="form-control" placeholder="Introduceti parola" data-rule="minlen:6" data-msg="Introduceti cel putin 6 caractere">
                        <div class="validation text-left text-danger"></div>
                    </div>
                    <div class="form-group">
                        <input type="password" name="re_pass" id="re_pass" class="form-control" placeholder="Re-introduceti parola" data-rule="minlen:6" data-msg="Introduceti cel putin 6 caractere">
                        <div class="validation text-left text-danger pwd-retype"></div>
                    </div>

                    <button type="submit" class="register btn btn-block" id="register">Inregistrare</button>

                    <div class="link mt-4">
                        <p>Esti deja inregistrat? <a href="index.php" id="loginLink">Logare </a></p>
                    </div>
                </form>
            </div>
            </row>
